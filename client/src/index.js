...
const httpURI = process.env.NODE_ENV === 'test' ? "http://localhost:4000" : 'https://to-do-gql-prisma.herokuapp.com/'
const wsURI = process.env.NODE_ENV == 'test' ? "ws://localhost:4000" : 'wss://to-do-gql-prisma.herokuapp.com/'
